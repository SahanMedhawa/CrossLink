                  ...
                  >
                    ...
                    <div style={styles.projectContent}>
                      ...
                      <div style={styles.projectDetails}>
                        <div style={{...styles.detailItem, ...styles.detailItemBorder}}>
                        ...
                        <div style={styles.detailItem}>
                          ...
                          <span style={styles.detailValue}>{formatDate(project.createdAt)}</span>
                        </div>
                      </div>
                      ...
                      {project.resources && project.resources.length > 0 && (
                        <div style={styles.resourcesSection}>
                          <h4 style={{...styles.h4, color: '#92400E'}}>Resources Needed</h4>
...
const EditProjectModal = ({ project, onClose, onUpdate }) => {
  ...
  const commonSkills = [
    ...
    'Writing', 'Photography', 'Event Planning', 'Fundraising'
  ];

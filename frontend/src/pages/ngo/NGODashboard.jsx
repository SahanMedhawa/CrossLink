      ...
      <div className="space-y-6 min-h-screen">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-600 rounded-2xl p-8 text-white mb-8">
          ...
          <p className="text-blue-100">
            Manage your projects, connect with volunteers, and track your impact.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          >
            ...
            <p className="text-sm text-gray-500">Post a new project to find volunteers</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow cursor-pointer">
            ...
            <h4 className="font-semibold text-gray-900 mb-2">Find Volunteers</h4>
            <p className="text-sm text-gray-500">Browse skilled volunteers</p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 hover:shadow-md transition-shadow cursor-pointer">
            ...
            <h4 className="font-semibold text-gray-900 mb-2">Corporate Partners</h4>
            <p className="text-sm text-gray-500">Connect with corporate sponsors</p>
          </div>
        </div>
